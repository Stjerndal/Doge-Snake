...
public class HelpScreen3 extends Screen {      
    ...
    public void present(float deltaTime) {
        ...
        g.drawPixmap(Assets.help3, V.help_screenPositionX, V.help_screenPositionY);
        g.drawPixmap(Assets.buttons, V.help_nextButtonPositionX, V.help_nextButtonPositionY, V.cancelButtonInnerPositionX, V.cancelButtonInnerPositionY, V.buttonWidth, V.buttonHeight);
    }
